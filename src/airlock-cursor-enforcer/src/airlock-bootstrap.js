#!/usr/bin/env node
/**
 * Airlock Bootstrap Script — Cursor
 * ===================================
 * Minimal transport-only script invoked by Cursor's hooks system.
...
// Compute from the working directory — Cursor invokes hooks with cwd = workspace root
